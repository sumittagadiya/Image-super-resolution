...
MODEL_JSON_PATH = 'saved_model/edsr_model.json'
# trained model weights
MODEL_PATH_BICUBIC = 'saved_model/edsr_350000.h5'
MODEL_PATH_UNKNOWN = 'saved_model/edsr_unknown_x4.h5'
